...
class AmbulanceDetails(models.Model):  
    ...
    profile_pic                =           models.ImageField(upload_to="hospital/services/images",blank=True,null=True,default="")
...
class Blog(models.Model):
    ...
    blog_image              =           models.ImageField(upload_to="hospital/blog/images",blank=True,null=True,default="")
    is_active               =           models.BooleanField(blank=True,null=True,default=False)
    created_at              =           models.DateTimeField(auto_now_add=True)
    updated_at              =           models.DateTimeField(auto_now=True)
    objects                 =           models.Manager()
