    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opd_charges', models.FloatField(blank=True, default=0.0, null=True)),
                ('home_charges', models.FloatField(blank=True, default=0.0, null=True)),
                ('emergency_charges', models.FloatField(blank=True, default=0.0, null=True)),
                ('online_charges', models.FloatField(blank=True, default=0.0, null=True)),
                ...
                ('doctor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='hospitaldoctor', to='accounts.hospitaldoctors')),
                ('hospital', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hospitalstaffdoctors', to='accounts.hospitals')),
            ],
        ),
        migrations.CreateModel(
            name='TimeSlot',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital.hospitalstaffdoctors')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_number', models.CharField(blank=True, default='', max_length=500, null=True, unique=True)),
