    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ID_proof', models.ImageField(blank=True, default='', null=True, upload_to='someone/ID/images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('invoicepdf', models.ImageField(blank=True, default='', max_length=164, null=True, upload_to='')),
                ('is_active', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.ImageField(blank=True, default='', null=True, upload_to='')),
                ('invoice', models.ImageField(blank=True, default='', null=True, upload_to='booking/invoices')),
                ('prescription', models.ImageField(blank=True, default='', max_length=256, null=True, upload_to='booking/prescription')),
                ('store_invoice', models.ImageField(blank=True, default='', max_length=256, null=True, upload_to='booking/store_invoice')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('HLP', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='merchant', to=settings.AUTH_USER_MODEL)),
                ('for_whom', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='patient.forsome')),
                ('hospitalstaffdoctor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='doctorbooking', to='accounts.hospitaldoctors')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('prescription', models.ImageField(blank=True, default='', max_length=256, null=True, upload_to=None)),
                ('store_invoice', models.ImageField(blank=True, default='', max_length=256, null=True, upload_to=None)),
                ('amount', models.FloatField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.ImageField(blank=True, default='', null=True, upload_to='patients/documents/file')),
                ...
                ('hospitaldoctors', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.hospitaldoctors')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BI_content', models.ImageField(blank=True, choices=[(1, 'bottle'), (2, 'Injection')], default='', null=True, upload_to='')),
